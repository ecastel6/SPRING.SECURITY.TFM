...
INSERT INTO BOOKS (id, author, title, price, description) VALUES (1, 'John Grisham', 'The Rooster Bar', 13.0,
                                                                  'Mucho antes de que su nombre se convirtiera en sinónimo del thriller legal moderno.');
INSERT INTO BOOKS (id, author, title, price, description) VALUES
  (2, 'Daniel Ellsberg', 'The doomsday machine', 19.49, 'Antes de los documentos del Pentágono, antes de Watergate');
INSERT INTO BOOKS (id, author, title, price, description) VALUES (3, 'Nora Roberts', 'Year One', 19.58,
                                                                  'Una sorprendente nueva novela de la autora número uno del New York Times, Nora Roberts-Year One, es una epopeya de esperanza y horror, caos y magia');
